    ...
    <div className="aboutGrid">
      <div className="aboutMain">
        ...
        <p className="p">
          ...
          heartbeat, ambient sound, breathing light, and subtle scent — a
          full sensory system designed around care, not command.
        </p>
        ...
        <p className="p">
          ...
          alexis clairaut employed two human "computers" — the title for
          apprentices at the time — to refine halley's comet predictions.
          before the machine, computation was a body. the soft computer
          draws from that thread while insisting that softness can be a
          rigorous interface, not a metaphor.
        </p>
        ...
        <div className="aboutTwoCol">
          ...
          <div className="aboutCard">
            ...
            <ul className="aboutList">
              ...
              <li>
                scent — dried lavender embedded in the foam interior,
                subtle and domestic
              </li>
              <li>
        ...
        <div className="aboutCallouts">
          <div className="aboutCallout">
            ...
            <p className="p small">
              four plush buttons each bias a markov chain toward a
              different corpus — care and tenderness, computational
              language subverted, textile and weaving vocabulary, dreamlike
          ...
          <div className="aboutCallout">
            ...
            <p className="p small">
              ...
              the system knows it is being held. the heartbeat quickens.
              the sound shifts warmer. the screen shows a line only visible
              in this moment. a hard computer cannot know it is being loved.
              this one does.
            </p>
          </div>
          <div className="aboutCallout">
        ...
        <section className="knownsUnknowns">
          <div className="kuBlock">
            ...
            <ul>
              ...
              <li>
                flexible 10.3" e-ink screen ordered
              </li>
              <li>
        ...
        <p className="p">
          ...
          allison parrish, a course centered on computational text,
          natural language processing, and small-scale predictive models
          including markov chains. rather than relying on large opaque
          language models, the soft computer uses lightweight and
          interpretable methods — small probabilistic systems, curated
          corpora, and modest models that align with the project's values of
          transparency, slowness, and materiality. each of the four buttons
          biases the system toward a different emotional corpus. the poem
          is built from touch.
        </p>
      ...
      <aside className="aboutAside">
        ...
        <div className="aboutMeta" style={{ marginTop: 12 }}>
          ...
          <ul className="aboutList small">
            <li>
              alexis clairaut — employed human "computers" to predict
              halley's comet, 1757
            </li>
